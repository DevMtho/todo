...
/**
 * Base class that represents a row from the 'venues' table.
 *
 *
 *
 * @package    propel.generator.todo.om
 */
abstract class BaseVenues extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'VenuesPeer';
    ...
    /**
     * The value for the venue_name field.
     * @var        string
     */
    ...
    /**
     * Get the [venue_name] column value.
     *
     * @return string
     */
     ...
     * @return Venues The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = VenuesPeer::ID;
        }
    ...
    /**
     * Set the value of [venue_name] column.
     *
     * @param string $v new value
     * @return Venues The current object (for fluent API support)
     */
    public function setVenueName($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->venue_name !== $v) {
            $this->venue_name = $v;
            $this->modifiedColumns[] = VenuesPeer::VENUE_NAME;
        }
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[] = VenuesPeer::CITY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->venue_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 3; // 3 = VenuesPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Venues object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VenuesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VenuesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VenuesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VenuesPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(VenuesPeer::VENUE_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`venue_name`';
        }
        if ($this->isColumnModified(VenuesPeer::CITY)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`venue_name`':
                        $stmt->bindValue($identifier, $this->venue_name, PDO::PARAM_STR);
                        break;
                    case '`city`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VenuesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VenuesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Venues'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Venues'][$this->getPrimaryKey()] = true;
        $keys = VenuesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getVenueName(),
            $keys[2] => $this->getCity(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setVenueName($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VenuesPeer::ID)) $criteria->add(VenuesPeer::ID, $this->id);
        if ($this->isColumnModified(VenuesPeer::VENUE_NAME)) $criteria->add(VenuesPeer::VENUE_NAME, $this->venue_name);
        if ($this->isColumnModified(VenuesPeer::CITY)) $criteria->add(VenuesPeer::CITY, $this->city);
    ...
    {
        $criteria = new Criteria(VenuesPeer::DATABASE_NAME);
        $criteria->add(VenuesPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Venues (or compatible) type.
    ...
    {
        $copyObj->setVenueName($this->getVenueName());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Venues Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Venues is new, it will return
     ...
     * Otherwise if this Venues is new, it will return
     * an empty collection; or if this Venues has previously
     * been saved, it will retrieve related Eventss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Venues.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(VenuesPeer::DEFAULT_STRING_FORMAT);
    }
