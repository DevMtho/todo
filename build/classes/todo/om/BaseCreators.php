...
/**
 * Base class that represents a row from the 'creators' table.
 *
 *
 *
 * @package    propel.generator.todo.om
 */
abstract class BaseCreators extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CreatorsPeer';
     ...
     * @return Creators The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CreatorsPeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = CreatorsPeer::NAME;
        }
    ...
    public function setCellNumber($v)
    {
        ...
        if ($this->cell_number !== $v) {
            $this->cell_number = $v;
            $this->modifiedColumns[] = CreatorsPeer::CELL_NUMBER;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->cell_number = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = CreatorsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Creators object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CreatorsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CreatorsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CreatorsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CreatorsPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CreatorsPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(CreatorsPeer::CELL_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = '`cell_number`';
        }

        $sql = sprintf(
            'INSERT INTO `creators` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`name`':
                        ...
                        break;
                    case '`cell_number`':
                        $stmt->bindValue($identifier, $this->cell_number, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CreatorsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CreatorsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Creators'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Creators'][$this->getPrimaryKey()] = true;
        $keys = CreatorsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getCellNumber(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setCellNumber($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CreatorsPeer::ID)) $criteria->add(CreatorsPeer::ID, $this->id);
        if ($this->isColumnModified(CreatorsPeer::NAME)) $criteria->add(CreatorsPeer::NAME, $this->name);
        if ($this->isColumnModified(CreatorsPeer::CELL_NUMBER)) $criteria->add(CreatorsPeer::CELL_NUMBER, $this->cell_number);
    ...
    {
        $criteria = new Criteria(CreatorsPeer::DATABASE_NAME);
        $criteria->add(CreatorsPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Creators (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setCellNumber($this->getCellNumber());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Creators Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Creators is new, it will return
    ...
    public function setEventss(PropelCollection $eventss, PropelPDO $con = null)
    {
        ...
        foreach ($eventssToDelete as $eventsRemoved) {
            $eventsRemoved->setCreators(null);
        }
     ...
     * Otherwise if this Creators is new, it will return
     * an empty collection; or if this Creators has previously
     * been saved, it will retrieve related Eventss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Creators.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Events[] List of Events objects
     */
    public function getEventssJoinDrinks($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = EventsQuery::create(null, $criteria);
        $query->joinWith('Drinks', $join_behavior);
    ...
    {
        return (string) $this->exportTo(CreatorsPeer::DEFAULT_STRING_FORMAT);
    }
