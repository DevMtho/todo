...
/**
 * Base class that represents a row from the 'drinks' table.
 *
 *
 *
 * @package    propel.generator.todo.om
 */
abstract class BaseDrinks extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DrinksPeer';
    ...
    /**
     * The value for the drink_name field.
     * @var        string
     */
    protected $drink_name;

    /**
     * The value for the drink_type field.
     * @var        string
     */
    ...
    /**
     * Get the [drink_name] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [drink_type] column value.
     *
     * @return string
     */
     ...
     * @return Drinks The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = DrinksPeer::ID;
        }
    ...
    /**
     * Set the value of [drink_name] column.
     *
     * @param string $v new value
     * @return Drinks The current object (for fluent API support)
     */
    public function setDrinkName($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->drink_name !== $v) {
            $this->drink_name = $v;
            $this->modifiedColumns[] = DrinksPeer::DRINK_NAME;
        }
    ...
    /**
     * Set the value of [drink_type] column.
     *
     * @param string $v new value
     * @return Drinks The current object (for fluent API support)
     */
    public function setDrinkType($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->drink_type !== $v) {
            $this->drink_type = $v;
            $this->modifiedColumns[] = DrinksPeer::DRINK_TYPE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->drink_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->drink_type = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = DrinksPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Drinks object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DrinksPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DrinksQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DrinksPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DrinksPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(DrinksPeer::DRINK_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`drink_name`';
        }
        if ($this->isColumnModified(DrinksPeer::DRINK_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`drink_type`';
        }

        $sql = sprintf(
            'INSERT INTO `drinks` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`drink_name`':
                        $stmt->bindValue($identifier, $this->drink_name, PDO::PARAM_STR);
                        break;
                    case '`drink_type`':
                        $stmt->bindValue($identifier, $this->drink_type, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = DrinksPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = DrinksPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getDrinkName();
                break;
            case 2:
                return $this->getDrinkType();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['Drinks'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Drinks'][$this->getPrimaryKey()] = true;
        $keys = DrinksPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getDrinkName(),
            $keys[2] => $this->getDrinkType(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setDrinkName($value);
                break;
            case 2:
                $this->setDrinkType($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setDrinkName($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setDrinkType($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DrinksPeer::ID)) $criteria->add(DrinksPeer::ID, $this->id);
        if ($this->isColumnModified(DrinksPeer::DRINK_NAME)) $criteria->add(DrinksPeer::DRINK_NAME, $this->drink_name);
        if ($this->isColumnModified(DrinksPeer::DRINK_TYPE)) $criteria->add(DrinksPeer::DRINK_TYPE, $this->drink_type);
    ...
    {
        $criteria = new Criteria(DrinksPeer::DATABASE_NAME);
        $criteria->add(DrinksPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Drinks (or compatible) type.
    ...
    {
        $copyObj->setDrinkName($this->getDrinkName());
        $copyObj->setDrinkType($this->getDrinkType());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Drinks Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Drinks is new, it will return
        ...
        if (null === $this->collEventss || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collEventss) {
                ...
                if (null !== $criteria) {
                    ...
                    $collEventss->getInternalIterator()->rewind();
                    return $collEventss;
                }
     ...
     * Otherwise if this Drinks is new, it will return
     * an empty collection; or if this Drinks has previously
     * been saved, it will retrieve related Eventss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Drinks.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Events[] List of Events objects
     */
    public function getEventssJoinVenues($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = EventsQuery::create(null, $criteria);
        $query->joinWith('Venues', $join_behavior);
     ...
     * @return PropelObjectCollection|Events[] List of Events objects
     */
    public function getEventssJoinSponsors($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = EventsQuery::create(null, $criteria);
        $query->joinWith('Sponsors', $join_behavior);
     ...
     * @return PropelObjectCollection|Events[] List of Events objects
     */
    public function getEventssJoinCreators($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = EventsQuery::create(null, $criteria);
        $query->joinWith('Creators', $join_behavior);
    ...
    {
        return (string) $this->exportTo(DrinksPeer::DEFAULT_STRING_FORMAT);
    }
