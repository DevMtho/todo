...
abstract class BaseSponsorsPeer
{
    ...
    const SPONSOR_NAME = 'sponsors.sponsor_name';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of Sponsors objects.
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'SponsorName', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'sponsorName', ),
        BasePeer::TYPE_COLNAME => array (SponsorsPeer::ID, SponsorsPeer::SPONSOR_NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'SPONSOR_NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'sponsor_name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'SponsorName' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'sponsorName' => 1, ),
        BasePeer::TYPE_COLNAME => array (SponsorsPeer::ID => 0, SponsorsPeer::SPONSOR_NAME => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'SPONSOR_NAME' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'sponsor_name' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(SponsorsPeer::ID);
            $criteria->addSelectColumn(SponsorsPeer::SPONSOR_NAME);
        } else {
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(SponsorsPeer::ID) && $criteria->keyContainsValue(SponsorsPeer::ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(SponsorsPeer::ID);
            $value = $criteria->remove(SponsorsPeer::ID);
            if ($value) {
                $selectCriteria->add(SponsorsPeer::ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(SponsorsPeer::ID, (array) $values, Criteria::IN);
            // invalidate the cache for this object(s)
            foreach ((array) $values as $singleval) {
                SponsorsPeer::removeInstanceFromPool($singleval);
            }
        }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = SponsorsPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria = new Criteria(SponsorsPeer::DATABASE_NAME);
        $criteria->add(SponsorsPeer::ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(SponsorsPeer::DATABASE_NAME);
            $criteria->add(SponsorsPeer::ID, $pks, Criteria::IN);
            $objs = SponsorsPeer::doSelect($criteria, $con);
        }
