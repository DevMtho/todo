 ...
 */
abstract class BaseSponsors extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'SponsorsPeer';
     ...
     * @return Sponsors The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = SponsorsPeer::ID;
        }
    ...
    public function setSponsorName($v)
    {
        ...
        if ($this->sponsor_name !== $v) {
            $this->sponsor_name = $v;
            $this->modifiedColumns[] = SponsorsPeer::SPONSOR_NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->sponsor_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = SponsorsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Sponsors object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SponsorsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SponsorsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SponsorsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = SponsorsPeer::ID;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . SponsorsPeer::ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(SponsorsPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(SponsorsPeer::SPONSOR_NAME)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SponsorsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SponsorsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Sponsors'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Sponsors'][$this->getPrimaryKey()] = true;
        $keys = SponsorsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getSponsorName(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setSponsorName($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SponsorsPeer::ID)) $criteria->add(SponsorsPeer::ID, $this->id);
        if ($this->isColumnModified(SponsorsPeer::SPONSOR_NAME)) $criteria->add(SponsorsPeer::SPONSOR_NAME, $this->sponsor_name);
    ...
    {
        $criteria = new Criteria(SponsorsPeer::DATABASE_NAME);
        $criteria->add(SponsorsPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Sponsors (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Sponsors Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Sponsors is new, it will return
    ...
    public function setEventss(PropelCollection $eventss, PropelPDO $con = null)
    {
        ...
        foreach ($eventssToDelete as $eventsRemoved) {
            $eventsRemoved->setSponsors(null);
        }
     ...
     * Otherwise if this Sponsors is new, it will return
     * an empty collection; or if this Sponsors has previously
     * been saved, it will retrieve related Eventss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Sponsors.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(SponsorsPeer::DEFAULT_STRING_FORMAT);
    }
